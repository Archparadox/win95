...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775043774932-ez5n6r | 2026-04-01T11:42:55.461Z

**Codebase Map:**
  app/: page, page, layout, page, page, page
  components/: DesktopIcon, DesktopPortfolio, DesktopWindow, ScrollFrame, Taskbar
  data/: portfolio
  (root): eslint.config, next.config
